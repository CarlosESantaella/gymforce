...
<div class="seccion-areas">
    <ul class="contenedor-areas" >
        <li class="area">
            ...
            ?>
            <img src="<?= esc_url($imagen)?>" alt="">
            <p><?= $area1['area_texto'] ?></p>
        </li>
        <li class="area">
            <?php 
...
<section class="clases">
    <div class="contenedor seccion">
        ...
        <?php gymforce_lista_clases(4); ?>
        <div class="contenedor-boton">
            <a href="<?= esc_url(get_permalink(get_page_by_title('Nuestras Clases'))); ?>"
